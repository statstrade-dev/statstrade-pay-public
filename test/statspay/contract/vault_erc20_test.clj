(ns statspay.contract.vault-erc20-test
  (:use code.test)
...
(defn get-approved
  [i]
  (s/with:contract-address [*erc20-address*]
    (source/allowance (nth env/+default-addresses-raw+ i)
                      *contract-address*)))
...
(defn approve-amount
  ...
  (s/with:contract-address [*erc20-address*]
     (s/with:caller-private-key [(nth env/+default-private-keys+ i)]
       (source/approve *contract-address* amount))))
...
(fact "gets the message sender, for debugging"
  ...
  (s/with:contract-address [*erc20-address*]
    (source/balanceOf *contract-address*))
  => 200000

  (s/with:contract-address [*erc20-address*]
    (source/balanceOf (second env/+default-addresses-raw+)))
  => 9999999800000
  
  (s/with:contract-address [*contract-address*]
    (t/g:VaultAccounts "T00001" (nth env/+default-addresses+ 1)))
...
^{:refer statspay.contract.vault-erc20/user:withdraw-request.multiple :added "0.1" :adopt true
...
^{:refer statspay.contract.vault-erc20/ut:assert-admin :added "0.1"
...
(fact "asserts that address is admin"
  ...
  (s/with:open-methods
   (t/ut:assert-admin (second env/+default-addresses-raw+)))
  => h/wrapped?

  (s/with:open-methods
   (t/site:add-support (second env/+default-addresses-raw+))
   (t/ut:assert-admin (second env/+default-addresses-raw+)))
  => [])

^{:refer statspay.contract.vault-erc20/ut:assert-owner :added "0.1"
  :setup [(s/with:open-methods
           (prep-contract))
          (create-vault 9)]}
...
^{:refer statspay.contract.vault-erc20/ut:assert-management :added "0.1"
  :setup [(s/with:open-methods
           (prep-contract)
           (create-vault 9))]}
...
^{:refer statspay.contract.vault-erc20/ut:get-account :added "0.1"
  :setup [(s/with:open-methods
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/ut:get-withdraw :added "0.1"
  :setup [(s/with:open-methods
           (do (prep-contract)
               (create-vault)
               (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/site:change-authority :added "0.1"}
(fact "changes the site authority")

^{:refer statspay.contract.vault-erc20/site:add-support :added "4.0"
...
(fact "adds supporting keys to the contract"
  ...
  (s/with:params {:caller-private-key (nth env/+default-private-keys+ 0)}
    (s/with:measure
     (t/site:remove-support (second env/+default-addresses-raw+))))
  => (contains-in
...
^{:refer statspay.contract.vault-erc20/site:remove-support :added "4.0"}
(fact "removes supporting keys from the contract")

^{:refer statspay.contract.vault-erc20/site:vault-create :added "0.1"
  :setup [(s/with:measure
           (prep-contract))]}
...
^{:refer statspay.contract.vault-erc20/site:account-open :added "0.1"
  :setup [(s/with:measure
           (prep-contract))
          (create-vault 9)]}
...
^{:refer statspay.contract.vault-erc20/site:account-close :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/owner:set-auto :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
(fact "sets auto withdraw"
  ...
  (s/with:params {:caller-private-key (nth env/+default-private-keys+ 9)}
    (s/with:measure
     (t/owner:set-auto "T00001" true)))
  => (contains-in
      [(approx 0.05 0.02) map?])
...
^{:refer statspay.contract.vault-erc20/owner:account-open-confirm :added "0.1"}
(fact "confirms the account using room owner key")

^{:refer statspay.contract.vault-erc20/owner:account-lock :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/owner:account-unlock :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/user:arbitration-vote :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
...
^{:refer statspay.contract.vault-erc20/user:arbitration-unvote :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/user:withdraw-request :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/site:withdraw-confirm :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/site:withdraw-reject :added "0.1"
  :setup [(s/with:measure
           (do (prep-contract)
               (create-vault 9)
               (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/ut:withdraw-transfer :added "0.1"}
(fact "helper function to facilitate transfer")

^{:refer statspay.contract.vault-erc20/owner:withdraw-approve :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/owner:withdraw-reject :added "0.1"
  :setup [(s/with:measure
           (prep-contract)
           (create-vault 9)
           (t/site:account-open
...
^{:refer statspay.contract.vault-erc20/user:withdraw-self :added "0.1"
  :setup [(s/with:measure
           (do (prep-contract)
               (create-vault 9)
...
^{:refer statspay.contract.vault-erc20/user:account-deposit :added "0.1"
  :setup [(s/with:measure
           (do (prep-contract)
               (create-vault 9)
               (t/site:account-open
